...
if(builtin_freetype)
  ...
  if(WIN32)
    ...
    ExternalProject_Add(
      ...
      URL_HASH SHA256=76ad1a252579566cb0859933a638f4301fee03527be18ce88030fdaa749678db
      ...
      CMAKE_ARGS -G ${CMAKE_GENERATOR} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}
                 ...
                 "-DFT_WITH_ZLIB=ON" "-DZLIB_INCLUDE_DIR=${ZLIB_INCLUDE_DIR}"
                 "-DZLIB_LIBRARY=${CMAKE_BINARY_DIR}/lib/ZLIB.lib"
