...
#pragma warning(disable: 869)
   ...
   private:
      ...
      public:
         ...
         inline math_token_t(
                             const bounding_box_t bounding_box,
                             const char32_t glyph, const unsigned int family,
                             const float size)
         : _offset(0, 0), _bounding_box(bounding_box),
   ...
   protected:
      ...
      /////////////////////////////////////////////////////////////
      // Symbol rendering
      static bool is_wgl_4(const char32_t c);
      static bool is_left_to_right(const char32_t c);
      static bool is_right_to_left(const char32_t c);
      static bool is_top_to_bottom(const char32_t c);
      static bool is_cyrillic(const char32_t c);
      static bool is_cjk(const char32_t c);
      static bool is_cjk_punctuation_open(const char32_t c);
      static bool is_cjk_punctuation_closed(const char32_t c);
      bounding_box_t math_bounding_box(
                                       const char32_t &glyph, const unsigned int family,
                                       const float size);
      void math_text(
                     const point_t origin, const char32_t &glyph,
      ...
      void extensible_glyph(
                            char32_t glyph[4], unsigned long &nrepeat,
                            const math_text_t::math_symbol_t &math_symbol,
