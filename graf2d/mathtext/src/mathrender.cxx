...
////////////////////////////////////////////////////////////////////////////////
   ...
   bool math_text_renderer_t::is_cyrillic(const char32_t c)
   {
      return c >= U'\u0400' && c <= U'\u052f';
   }
...
////////////////////////////////////////////////////////////////////////////////
   ...
   bool math_text_renderer_t::is_cjk(const char32_t c)
   {
      return
...
////////////////////////////////////////////////////////////////////////////////
   ...
   bool math_text_renderer_t::is_wgl_4(const char32_t c)
   {
      return true;
   }
#endif
...
/// @see http://www.unicode.org/reports/tr9/tr9-21.html
   ...
   bool math_text_renderer_t::is_right_to_left(const char32_t c)
   {
      return
      (// Hebrew ... N'Ko
       (c >= U'\u0590' && c <= U'\u07ff') ||
...
////////////////////////////////////////////////////////////////////////////////
   ...
   bool math_text_renderer_t::is_cjk_punctuation_open(const char32_t c)
   {
      return false;
   }
...
////////////////////////////////////////////////////////////////////////////////
   ...
   bool math_text_renderer_t::is_cjk_punctuation_closed(const char32_t c)
   {
      return false;
   }
#endif
...
////////////////////////////////////////////////////////////////////////////////
   ...
   bounding_box_t math_text_renderer_t::
   math_bounding_box(const char32_t &glyph,
...
////////////////////////////////////////////////////////////////////////////////
   ...
   void math_text_renderer_t::
   math_text(const point_t origin, const char32_t &glyph,
             const unsigned int family, const float size,
             const bool render_structure)
   {
      set_font_size(size, family);
