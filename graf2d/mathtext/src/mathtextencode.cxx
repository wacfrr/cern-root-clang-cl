...
#include "table/mathglyphstd.h"
   ...
   void math_text_t::math_symbol_t::encode_math_blackboard_bold(void)
   {
      ...
      if(_code[0] >= 'A' && _code[0] <= 'Z') {
         ...
         switch(_code[0]) {
            case 'C':   _glyph = U'\u2102'; break;
            case 'H':   _glyph = U'\u210d'; break;
            case 'N':   _glyph = U'\u2115'; break;
            case 'P':   _glyph = U'\u2119'; break;
            case 'Q':   _glyph = U'\u211a'; break;
            case 'R':   _glyph = U'\u211d'; break;
            case 'Z':   _glyph = U'\u2124'; break;
   ...
   void math_text_t::math_symbol_t::encode_math_script_italic(void)
   {
      ...
      if(_code[0] >= 'A' && _code[0] <= 'Z') {
         ...
         switch(_code[0]) {
            case 'H':   _glyph = U'\u210b'; break;
            case 'I':   _glyph = U'\u2110'; break;
            case 'L':   _glyph = U'\u2112'; break;
            case 'P':   _glyph = U'\u2118'; break;
            case 'R':   _glyph = U'\u211b'; break;
            case 'B':   _glyph = U'\u212c'; break;
            case 'E':   _glyph = U'\u2130'; break;
            case 'F':   _glyph = U'\u2131'; break;
            case 'M':   _glyph = U'\u2133'; break;
         ...
         _family = FAMILY_STIX_ITALIC;
         switch(_code[0]) {
            case 'g':   _glyph = U'\u210a'; break;
            case 'l':   _glyph = U'\u2113'; break;
            case 'e':   _glyph = U'\u212f'; break;
            case 'o':   _glyph = U'\u2134'; break;
   ...
   void math_text_t::math_symbol_t::encode_math_fraktur_regular(void)
   {
      ...
      if(_code[0] >= 'A' && _code[0] <= 'Z') {
         _family = FAMILY_STIX_REGULAR;
         switch(_code[0]) {
            case 'H':   _glyph = U'\u210c'; break;
            case 'I':   _glyph = U'\u2111'; break;
            case 'R':   _glyph = U'\u211c'; break;
            case 'Z':   _glyph = U'\u2128'; break;
            case 'C':   _glyph = U'\u212d'; break;
