...
//#define _NAME4_(name1,name2,name3,name4) _NAME3_(name1,name2,name3)
#define _NAME4_(name1,name2,name3,name4) name1##name2##name3##name4
...
{\
   ...
   if (!batch) ::operator delete(fParam);;\
   DEBUG_PROFILE_PROXY_STOP(method)\
}
